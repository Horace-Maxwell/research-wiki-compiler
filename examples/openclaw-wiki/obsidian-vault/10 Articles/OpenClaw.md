...
updated_at: '2026-04-05T19:36:56.639Z'
status: active
aliases:
  - open claw
tags:
...
- Load this first when you need the shortest durable statement of what the corpus says OpenClaw is.
...
- [Workflow cautions](#workflow-cautions)
- [Configuration drift signals](#configuration-drift-signals)
- [Tensions](#tensions)
